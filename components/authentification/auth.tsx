                            ...
                            <form onSubmit={handleSubmit(async (data: any) => {
                                ...
                                <ModalBody>
                                    ...
                                    {authMode === "register" && (
                                        <div className="flex flex-col gap-4">
                                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                                Rejoignez CESIZEN et retrouvez votre équilibre intérieur.
                                            </p>
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <Checkbox
                                                    size="sm"
                                                    classNames={{ label: "text-tiny text-gray-500 dark:text-gray-400" }}
                                                    color="default"
                                                    {...register("acceptedCGU", { required: "Veuillez accepter les Conditions Générales d'Utilisation." })}
                                                    isInvalid={!!errors.acceptedCGU}
                                                >
                                                    J’accepte les{" "}
                                                    <Link href="#" className="text-tiny text-blue-700 dark:text-blue-400 underline">
                                    ...
                                    {authMode === "forgotPassword" && (
                                        <div className="flex flex-col gap-4">
                                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                                Entrez votre adresse e-mail. Si elle correspond à un compte CESIZEN, nous vous enverrons un lien pour réinitialiser votre mot de passe.
                                            </p>
                                            <Input
                                ...
                                <ModalFooter className="flex flex-col gap-3">
                                    <Button className="bg-purple-800 hover:bg-purple-700 text-white w-full" type="submit">
                                        {authMode === "login" && "Se connecter"}
