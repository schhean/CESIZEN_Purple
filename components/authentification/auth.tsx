...
// Création d'un type userData pour stocker les données de connexion 
...
export default function Auth() {
    ...
    // État pour stocker les données des utilisateurs et des inscriptions
    ...
    // Fonction pour récupérer les données du formulaire de connexion ou d'inscription et les stocker dans l'état
    ...
    // Fonction permettant de faire appel à l'API /register pour la validation et l'envoie des données d'inscription
    const handleRegister = async (data: userInscriptionData) => {
        try {
            ...
            // Fermeture de la modale d'inscription
            onClose();

            // Affichage d'un toast de succès après l'inscription
            addToast({
                        ...
                        <>
                            ...
                            <form onSubmit={handleSubmit(async (data: any) => {
                                    ...
                                    {authMode === "login" ? (
                                        <div className="flex flex-col gap-4">
                                            ...
                                            <div className="flex justify-end">
                                                <Link className="text-purple-800 cursor-pointer" href="#" size="sm">
                                                    Mot de passe oublié ?
                                                </Link>
                                            </div>
                                        </div>
                                ...
                                <ModalFooter className="flex flex-col gap-3">
                                    <Button className="bg-purple-800 text-white w-full" type="submit">
                                    ...
                                    <div className="text-center w-full pb-2">
                                        <p className="text-sm text-gray-500">
                                            ...
                                            {" "}
                                            <span
                                                className="text-purple-800 font-bold cursor-pointer hover:underline"
