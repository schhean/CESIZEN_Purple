    ...
    <>
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mt-2 gap-4">
            <Button
              className="bg-purple-800 text-white font-semibold flex items-center gap-2"
              onPress={onOpen}
              type="button"
            >
            ...
            <div className="flex justify-end mt-2 gap-3 w-full sm:w-auto">
              {isEditing ? (
                <>
                  <Button color="danger" variant="light" onPress={handleCancel} isDisabled={isSubmitting}>
                    Annuler
                  </Button>
                  <Button
        ...
        <PasswordChangeModal isOpen={isOpen} onOpenChange={onOpenChange} onClose={onClose} />
    </>
  );
}