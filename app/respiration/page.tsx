    ...
    <div className="max-w-6xl mx-auto p-6 min-h-[80vh] bg-background">
      ...
      <div className="text-center mb-16 mt-8">
        ...
        <p className="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
          Prenez un moment pour vous recentrer. Choisissez un exercice guidé pour réduire votre stress, améliorer votre concentration ou faciliter le sommeil.
        </p>
      </div>
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3].map((skeleton) => (
            <div key={skeleton} className="h-[350px] bg-gray-100 dark:bg-zinc-800 rounded-2xl animate-pulse"></div>
          ))}
        </div>
      ) : exercices.length === 0 ? (
        ...
        <div className="text-center p-12 bg-white dark:bg-zinc-900 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm">
          ...
          <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">Aucun exercice disponible</h3>
          <p className="text-gray-500 dark:text-gray-400">Les exercices de respiration arriveront très bientôt.</p>
        </div>
      ) : (
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="grid grid-cols-3 gap-2 mb-6 mt-auto">
                  <div className="text-center p-2 rounded-xl bg-sky-50 dark:bg-sky-900/20 border border-sky-100 dark:border-sky-800/30">
                    <p className="text-lg font-bold text-sky-600 dark:text-sky-400">{exo.temps_inspiration}s</p>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold tracking-wider mt-0.5">Inspire</p>
                  </div>
                  <div className="text-center p-2 rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-800/30">
                    <p className="text-lg font-bold text-purple-600 dark:text-purple-400">{exo.temps_apnee}s</p>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold tracking-wider mt-0.5">Bloque</p>
                  </div>
                  <div className="text-center p-2 rounded-xl bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-800/30">
                    <p className="text-lg font-bold text-teal-600 dark:text-teal-400">{exo.temps_expiration}s</p>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold tracking-wider mt-0.5">Expire</p>
                  </div>
                </div>
