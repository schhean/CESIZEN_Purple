...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contactez l'equipe CESIZEN pour une question, une aide ou un retour.",
};
...
const contactCards = [
  {
    title: "Nous ecrire",
    description:
      "Pour une question generale, une remarque ou une demande d'information.",
      ...
      <div className="mx-auto max-w-6xl">
        <section className="mb-12 text-center md:mb-16">
          ...
          <p className="mx-auto max-w-2xl text-base leading-relaxed text-gray-600 dark:text-gray-400 md:text-lg">
            Une question, une suggestion ou besoin d'aide ? Notre equipe vous
            repond avec attention pour vous accompagner dans votre experience.
          </p>
        </section>
        ...
        <section className="mb-12 grid grid-cols-1 gap-5 md:grid-cols-3">
          {contactCards.map((card) => {
            ...
            return (
              ...
              >
                <div
                  className={`mb-5 flex h-12 w-12 items-center justify-center rounded-2xl border ${card.background} ${card.border} ${card.color}`}
                >
        ...
        <section className="grid grid-cols-1 gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <aside className="rounded-3xl border border-sky-100 bg-gradient-to-br from-sky-50 to-purple-50 p-6 dark:border-zinc-800 dark:from-sky-900/10 dark:to-purple-900/10 md:p-8">
            ...
            <p className="mb-6 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
              Nous faisons au mieux pour repondre sous 48 heures ouvrables. Pour
              une urgence medicale ou psychologique, contactez immediatement les
              services d'urgence ou un professionnel de sante.
            </p>
