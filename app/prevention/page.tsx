    ...
    <div className="max-w-6xl mx-auto p-6 min-h-[80vh]">
      ...
      <div className="text-center mb-16 mt-8">
        ...
        <p className="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
          Découvrez nos conseils, guides et articles rédigés par des experts pour mieux comprendre et gérer votre stress au quotidien.
        </p>
      </div>
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3].map((skeleton) => (
            <div key={skeleton} className="h-64 bg-gray-100 dark:bg-zinc-800 rounded-2xl animate-pulse"></div>
          ))}
        </div>
      ) : articles.length === 0 ? (
        <div className="text-center p-12 bg-white dark:bg-zinc-900 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm">
          ...
          <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">Aucun article pour le moment</h3>
          <p className="text-gray-500 dark:text-gray-400">Revenez très bientôt pour découvrir nos nouveaux contenus.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
