...
export default function HomeComponent() {
   ...
   */
  const [humeurSelectionnee, setHumeurSelectionnee] = useState<string | null>(
    null,
  );
    ...
    <div className="w-full pb-16 md:pb-24 overflow-x-hidden bg-background">
      <div className="bg-background relative flex min-h-[500px] w-full flex-col items-center justify-center overflow-hidden gap-4 md:gap-6 px-4 py-12 md:py-0">
        <p className="z-10 text-center text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tighter whitespace-pre-wrap text-black dark:text-white mt-8 md:mt-12">
          Bienvenue sur CESI
          <span className="text-purple-600 dark:text-purple-400">ZEN</span>
        </p>
        <p className="z-10 text-center text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl leading-relaxed px-2">
          Retrouvez votre équilibre intérieur en un seul souffle grâce à
          CESIZEN, votre refuge pour une meilleure santé mentale.
        </p>

        <div className="z-10 flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 md:mt-8 w-full sm:w-auto px-4 sm:px-0">
          <Link
            className="w-full sm:w-auto px-6 md:px-8 py-3.5 md:py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-full font-bold text-base md:text-lg transition-all shadow-lg shadow-purple-500/30 flex items-center justify-center gap-2 hover:scale-105"
            href="/respiration"
          >
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-xl shadow-purple-900/5 border border-gray-100 dark:border-zinc-800 text-center">
            ...
            {humeurs.map((humeur) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <span className="text-[10px] sm:text-xs font-semibold text-gray-600 dark:text-gray-400 text-center leading-tight">
                    {humeur.label}
                  </span>
                </button>
              );
          ...
          {humeurSelectionnee && (
            <div className="mt-6 md:mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {(humeurSelectionnee === "epuise" ||
                humeurSelectionnee === "stresse") && (
                <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">
                  Prenez une pause. Un exercice de{" "}
                  <Link
              ...
              {(humeurSelectionnee === "moyen" ||
                humeurSelectionnee === "bien" ||
                humeurSelectionnee === "super") && (
                <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">
                  Super ! C'est le moment idéal pour lire nos{" "}
                  <Link
                    className="text-teal-600 dark:text-teal-400 underline hover:text-teal-700"
                    href="/prevention"
                  >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 mt-16 md:mt-24">
        <div className="bg-gradient-to-r from-sky-50 to-purple-50 dark:from-sky-900/10 dark:to-purple-900/10 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 border border-sky-100 dark:border-zinc-800 flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 text-center md:text-left order-2 md:order-1">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white mb-3 md:mb-4">
              La respiration 4-7-8
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
              Un exercice scientifiquement prouvé pour calmer le système nerveux
              et favoriser un endormissement rapide. Parfait pour terminer la
              journée.
            </p>
            <Link
              className="inline-flex items-center justify-center md:justify-start gap-2 font-bold text-sky-600 dark:text-sky-400 hover:gap-3 transition-all w-full md:w-auto"
              href="/respiration"
            >
          ...
          <div className="w-32 h-32 md:w-48 md:h-48 rounded-full bg-gradient-to-tr from-sky-300 to-purple-400 opacity-80 blur-xl animate-pulse flex-shrink-0 order-1 md:order-2" />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          <div className="text-center p-4 sm:p-6 bg-white dark:bg-zinc-900 md:bg-transparent md:dark:bg-transparent rounded-2xl md:rounded-none shadow-sm md:shadow-none border border-gray-100 dark:border-zinc-800 md:border-none">
            ...
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">
              Seulement 5 minutes d'exercices par jour suffisent pour ressentir
          ...
          <div className="text-center p-4 sm:p-6 bg-white dark:bg-zinc-900 md:bg-transparent md:dark:bg-transparent rounded-2xl md:rounded-none shadow-sm md:shadow-none border border-gray-100 dark:border-zinc-800 md:border-none">
            ...
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">
              Basé sur les principes reconnus de la cohérence cardiaque pour
          ...
          <div className="text-center p-4 sm:p-6 bg-white dark:bg-zinc-900 md:bg-transparent md:dark:bg-transparent rounded-2xl md:rounded-none shadow-sm md:shadow-none border border-gray-100 dark:border-zinc-800 md:border-none sm:col-span-2 md:col-span-1">
            ...
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">
              Retrouvez votre calme intérieur sans artifice, simplement en
              réapprenant à maîtriser votre souffle.
            </p>
          </div>
        </div>
      </div>
